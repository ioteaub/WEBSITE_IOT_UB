                            ...
                            <span v-else class=" flex justify-center items-center">
                              <vue-load-image>
                                <template v-slot:image>
                                  <img :src="getUrl(todo.id)" height="20" alt="" class=" aspect-square w-full h-full rounded-xl">
                                </template>
                                <template v-slot:preloader>
                                  <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" style="margin: auto; background: rgba(241, 242, 243, 0); display: block; shape-rendering: auto;" width="40" height="40" viewBox="0 0 100 100" preserveAspectRatio="xMidYMid">
